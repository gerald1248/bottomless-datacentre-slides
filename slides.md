...
<aside class="notes" data-markdown>
This is surely the killer argument. Ideally code that runs twice as fast will cost half as much to run. That was not at all apparent in on-premises datacentres; still not abundantly clear when using virtual machines and later containers; but it is immediately apparent when in the serverless model.
</aside>
